...
- **Worker Deployment Hardening** — Added worker health endpoint, aligned package entrypoints for tsx runtime, marked platform-connector as ESM, and switched worker image to Debian with Prisma engine settings for reliable Railway deploys. (PR #140)

...
/**
 * M0.1: DTO Generator
 * Generates TypeScript DTOs from Prisma models for @calibr/types package
 */
...
const OUTPUT_FILE = join(OUTPUT_DIR, 'm0.1-dtos.ts');
...
// Write DTOs file
writeFileSync(OUTPUT_FILE, dtoContent);

console.log('✓ Generated M0.1 DTOs');
console.log(`  Location: ${OUTPUT_FILE}`);
console.log('  DTOs: Product, PriceVersion, DiscountPolicy, PriceChange, Event, Audit');

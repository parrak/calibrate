 ...
 */
export async function deliverToSlack(alert, policy, config) {
 ...
 */
export async function deliverToEmail(alert, policy, config) {
    if (!config) {
        return {
            channel: 'email',
            success: false,
 ...
 */
export async function deliverToPagerDuty(alert, policy, config) {
 ...
 */
export async function deliverToWebhook(alert, policy, config) {
    if (!config?.url) {
        return {
            channel: 'webhook',
            success: false,
 ...
 */
export async function deliverAlert(alert, policy, config) {
    const results = [];
 ...
 */
function generateEmailHtml(alert, policy) {
    const severityColor = {
        critical: '#D32F2F',
        warning: '#F57C00',
        info: '#1976D2'
 ...
 */
export function loadAlertDeliveryConfig() {
    return {
